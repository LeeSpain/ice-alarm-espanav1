...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      escalation_target_type: "browser_alert" | "mobile_call" | "emergency_contact_call"
      import_batch_status:
        | "uploaded"
        | "parsed"
        | "importing"
      ...
      participant_join_method: "automatic" | "accepted_alert" | "added_by_staff" | "callback_routed"
      participant_type: "member" | "staff" | "ai" | "emergency_contact" | "external_service"
